			...
			<Fragment>
				<form id="miForm">
					<div className="form-group">
						<label className="label-style">Ingrese una opearción</label>
					...
					<div className="form-group">
						<label className="label-style">Ingrese primer numero</label>
						<input type="text" className="form-control input-style" name="num1" id="num1" value={data.num1} onChange={onChange}/>
					</div>
					<div className="form-group">
						<label className="label-style">Ingrese segundo numero</label>
